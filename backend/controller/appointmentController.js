...
import { validate, calculateScore, buildQuery } from '../controller/nlSearchController.js';
...
export const scheduleViewing = async (req, res) => {
  try {
    const { propertyId, date, time, notes, name, email, phone, message, description } = req.body;
